...
import WeekwiseCalendar from './WeekwiseCalendar';
...
const DetailedCalendar = () => {
    ...
    return (
        <div className="py-5 px-8 bg-[#EDF0F5]">
            <div className="">
                <div className='flex'>
                    <h1 className="text-[#4F81D1] font-semibold text-[28px] mx-6">Calendar</h1>
                    <div className="flex items-center text-[18px]">
                        <label className="text-[#637799] mx-6 typ-1">
                            <input type="radio" name="type" className="text-[green] opacity-0" />
                            <span className="absolute h-[25px] w-[25px] rounded-[50%] bg-[#eee] hover:bg-[#ccc] checked:bg-[#2196F3] chk-1"><span className='chk-11'></span></span>
                ...
                <div className='flex border-[0.5px] rounded border-[#637799]'>
                    <div className='w-[300px] border-r-[0.5px] p-[15px] border-[#637799]' style={{ paddingRight: currentState === 2 ? '' : '35px' }}>
                        <div>
                    ...
                    <div className='' style={{ width: 'calc(100% - 300px)' }}>
                        <div className='flex items-center justify-between py-2 px-8 h-[100px] border-b-[0.5px] border-[#637799]'>
                            <div className='flex items-center'>
                                <button className='btn-1 bg-[#4F81D1] hover:bg-[#789dda]'>Today</button>
                                <div className='navi-btn-container' style={{ margin: '5px' }}>
                                    <button className='navi-btn btn-2 hov' style={{ borderStyle: 'none' }} onClick={goToPreviousMonth}>
                                ...
                                <path d="M0.392632 4.11293L5.22358 0.00292969L6.12402 0.768999L2.19353 4.11293L6.12402 7.45686L5.22358 8.22293L0.392632 4.11293Z" fill="#637799" />
                                    ...
                                    <button className='navi-btn btn-2 hov' style={{ borderStyle: 'none' }} onClick={goToNextMonth}>
